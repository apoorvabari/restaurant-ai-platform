...
const AnimatedMenuCard = ({ item, onAddToCart }) => {
  ...
  return (
    ...
    >
      {/* Image / Emoji Header */}
      <div className="h-48 bg-gradient-to-br from-brand-500/10 via-accent-500/5 to-transparent flex items-center justify-center relative overflow-hidden flex-shrink-0">
        {resolvedImageUrl ? (
          <motion.img
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        {item.description && (
          <motion.p 
            className="text-slate-500 text-sm line-clamp-2 mb-3 leading-relaxed flex-grow"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
