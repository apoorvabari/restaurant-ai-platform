    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-20 bg-gradient-to-b from-slate-950 via-slate-900 to-emerald-950">
      <div className="relative w-full max-w-md rounded-3xl border border-green-700/30 bg-slate-900/90 p-10 shadow-2xl shadow-black/40 backdrop-blur-xl">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-3xl font-bold text-white tracking-tight">Login with Keycloak</h1>
          <p className="mt-2 text-sm text-slate-300">Sign in through Keycloak identity management.</p>
        </div>

        <div className="space-y-6">
          <p className="text-sm text-slate-400">Keycloak handles authentication and user profile management. Click the button below to sign in.</p>
          <button
            type="button"
            onClick={handleLogin}
          ...
          <div className="rounded-2xl border border-slate-700 bg-slate-800/80 p-4 text-sm text-slate-300">
            If you don't have an account, Keycloak will prompt you to register during the login flow.
          </div>
        </div>
      </div>
    </div>
